  ...
  return (
    <div className="w-full min-h-screen bg-[#000000] text-white font-sans selection:bg-white selection:text-black overflow-x-hidden flex flex-col relative">
      ...
      <SEOHead 
        ...
        description="Information regarding how we collect, process, and secure your personal data." 
        canonicalUrl="https://anyastro.tech/legal/privacy-policy" 
      />
      ...
      <div className="w-full max-w-[1000px] mx-auto px-8 md:px-16 py-16 flex flex-col gap-16 flex-1 relative z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <h1 className="text-[3rem] md:text-[4rem] font-black tracking-tighter mb-4">Privacy Policy</h1>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={SectionVariants} className="bg-[#050505] border border-[#222222] p-8 rounded-2xl flex flex-col gap-4">
          <div className="w-12 h-12 rounded-xl bg-[#111111] border border-[#333333] flex items-center justify-center text-white mb-2">
            <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
          </div>
          <h2 className="text-[1.75rem] font-black tracking-tight">1. Data Collection Framework</h2>
          <p className="text-[#cccccc] leading-relaxed text-[1.05rem]">
            We strictly gather information essential for providing core platform functionality, ensuring optimal performance, and maintaining authenticated sessions. This includes verified authentication credentials, operational usage metrics, and direct administrative communications.
          </p>
        </motion.section>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={SectionVariants} className="bg-[#050505] border border-[#222222] p-8 rounded-2xl flex flex-col gap-4">
          ...
          <h2 className="text-[1.75rem] font-black tracking-tight">2. Data Retention Periods</h2>
          <p className="text-[#cccccc] leading-relaxed text-[1.05rem]">
            Personal records and operational logs are retained only as long as necessary to fulfill the business purposes outlined in this policy or to comply with applicable legal, tax, and accounting requirements. Upon expiration of the required retention cycle, data is securely purged from our storage nodes.
          </p>
        </motion.section>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={SectionVariants} className="bg-[#050505] border border-[#222222] p-8 rounded-2xl flex flex-col gap-4">
          ...
          <h2 className="text-[1.75rem] font-black tracking-tight">3. User Rights and Access Control</h2>
          <p className="text-[#cccccc] leading-relaxed text-[1.05rem]">
            Registered participants maintain full administrative rights to inspect, update, or request complete deletion of their personal information. All requests regarding data privacy rights are processed securely through our designated compliance center in accordance with enterprise governance standards.
          </p>
        </motion.section>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={SectionVariants} className="bg-[#050505] border border-[#222222] p-8 rounded-2xl flex flex-col gap-4">
          ...
          <h2 className="text-[1.75rem] font-black tracking-tight">4. International Data Transfers</h2>
          <p className="text-[#cccccc] leading-relaxed text-[1.05rem]">
            When organizational data is transferred across international geographic boundaries, we enforce strict encryption protocols and contractual safeguards to guarantee that your personal information remains protected under uniform security perimeters globally.
          </p>
        </motion.section>
