...
export default function AccessibilityWidget({ isOpen, onClose }) {
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute top-20 right-8 w-[320px] bg-[#050505] border border-[#333333] rounded-2xl shadow-2xl overflow-hidden flex flex-col z-[9999]"
        >
