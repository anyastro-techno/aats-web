...
export default function MaintenanceFooter({ currentT, setShowDeveloper, setShowHelpCenter, setShowSitemap, localCity }) {
  ...
  return (
    <footer className="w-full max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6 px-6 md:px-16 py-8 border-t border-[#111111] relative z-20 mt-auto">
      
      {/* Custom SVG Social Icons */}
      <div className="flex items-center gap-6 md:gap-8 text-[#555555]">
      ...
      {/* Navigation Links and City Info */}
      <div className="flex flex-wrap items-center justify-center md:justify-end gap-4 md:gap-6 text-[0.75rem] md:text-[0.8rem] font-bold text-[#555555]">
        ...
        <span className="w-1 h-1 bg-[#333333] rounded-full hidden sm:block"></span>
        ...
        {/* Scroll to Top Vector Button */}
        <button 
          onClick={scrollToTop} 
          aria-label="Scroll to top"
          className="ml-2 w-9 h-9 rounded-full bg-[#111111] border border-[#333333] flex items-center justify-center text-[#aaaaaa] hover:text-white hover:border-white transition-colors outline-none"
        >
